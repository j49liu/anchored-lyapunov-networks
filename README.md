...
screen and a $2^{18}$-point sampled-boundary check.  The larger archived 10D
stress-test ledger contains additional populations, attacks, and rollouts; it
is retained as evidence but is not wholly regenerated by this lightweight
release.
